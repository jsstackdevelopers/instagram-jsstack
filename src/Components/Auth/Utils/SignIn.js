...
import { setSigninState } from '../../App/UserSlice';
...
const SignIn = () => {
    ...
    const OnSignIn = async () => {
        await signInWithEmailAndPassword(auth, email, password).then((userCredential) => {
            ...
            alert(`User Not Exits in Database: ${error.message}`);
        })
    }
    ...
    return (
        <>
            ...
            <LoginButton type="button" onClick={OnSignIn}><span>Log In</span></LoginButton>
        </>
    );
};
